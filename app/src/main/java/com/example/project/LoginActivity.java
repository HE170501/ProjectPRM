                    ...
                    try{
                        if(id>0){
                            ...
                            if (user_name.getText().toString().equals("admin")){
                                startActivity(new Intent(LoginActivity.this, com.example.project.AdminActivity.class));
                                finish();
                            } else {
                                startActivity(new Intent(LoginActivity.this, com.example.project.HomeActivity.class));
                                finish();
                            }
                        }else{
